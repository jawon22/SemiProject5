...
<script>
    ...
    <div class="container w-600">
        ...
        <div class="row">
            <label>제목</label>
            <input type="text" name="boardTitle" class="form-input w-100" value="${boardDto.boardTitle}">
        </div>
    </div>
    <div class="container w-600">
        <div class="row left">
            <label>내용</label>
            <textarea type="text" name="boardContent" class="form-input w-100 fixed">${boardDto.boardContent}</textarea>
        </div>
        <div class="row">
