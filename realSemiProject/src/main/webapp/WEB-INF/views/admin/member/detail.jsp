...
<div class="container w-800 mt-20">
	<div class="flex-container auto-width">
		...
		<div class="row mv-10 w-25">
			...
			<c:choose>
				...
				<c:when test="${attachNo == null}">
					<img src="https://dummyimage.com/130x130/000/fff" width="130"
						height="130" class="image image-circle image-border profile-image">
				</c:when>
				<c:otherwise>
					<img src="/rest/member/download?attachNo=${attachNo}" width="130"
						height="130" class="image image-circle image-border profile-image">
				</c:otherwise>
			</c:choose>
		...
		<c:if test="${attachNo != null}">
			<div>
				<i class="fa-solid fa-circle-xmark profile-delete"
					style="color: #78bdcf; margin-right: 100%;"></i>
			</div>
		</c:if>
